...
| | ⚠️ Unverified, no source located: the opening versicle ("grant us a quiet night..."), the absolution ("The almighty and merciful Lord grant us pardon..." — the ancient precatory *Indulgentiam*; the 1881 book's own absolution is the declarative ministerial form, inappropriate for a recorded voice, so it was not adopted), the liturgist's bidding before the confession (the 1881 bidding is sermon-specific and does not fit Compline's order), the two closing collects ("Visit, we beseech Thee..." / "Be present, O merciful God..."), and the closing benediction. |
| **Recommendation** | Still the least-verified office, but no longer wholly unsourced — its longest and most doctrinally weighty text is now cited. Before publishing Compline episodes, either find a pre-1930 source for the remaining flagged lines, or accept them on the strength of their being ancient/traditional text rather than a checked citation, and say so plainly in the show notes. |
...
1. Compline's remaining flagged lines (opening versicle, absolution, pre-confession bidding, two collects, benediction) — no source located yet. **The Confession is now closed out** — verified against the 1881 Missouri Synod Church Liturgy.
